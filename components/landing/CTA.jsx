      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-4 lg:grid-cols-2">
        <div>
          ...
          <h2 className="mt-4 font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-ink md:text-5xl">
            ...
            <br className="hidden sm:block" /> <span className="italic font-light text-accent">in under 60 seconds</span>
          </h2>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            ...
            <a href="#features" className="inline-flex items-center gap-2 rounded-full border border-line bg-surface/70 px-5 py-3 text-sm font-semibold text-ink shadow-sm backdrop-blur transition-all hover:bg-surface hover:border-line-strong">
