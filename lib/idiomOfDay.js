...
export const IDIOM_OF_DAY_LIST = [
  { idiom: "A blessing in disguise", meaning: "A good thing that seemed bad at first.", example: "Losing that job was a blessing in disguise, because it pushed me to start my own business." },
  ...
  { idiom: "Call it a day", meaning: "Stop working on something for the day.", example: "We've done enough, so let's call it a day." },
  ...
  { idiom: "Peace of mind", meaning: "A feeling of calm because you have no worries.", example: "Insurance gives me peace of mind." },
  ...
  { idiom: "Steal someone's thunder", meaning: "Take attention or credit from someone.", example: "Don't announce it yet, or you'll steal her thunder." },
